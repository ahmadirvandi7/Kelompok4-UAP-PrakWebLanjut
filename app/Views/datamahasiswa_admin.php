...
<div class="container">
      ...
      <h2>Data Mahasiswa</h2>
        ...
        <a href="<?= base_url("/datamahasiswa_admin/create") ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Tambah Data
        </a>
        <br>
          ...
          <tbody>
              <?php foreach ($mahasiswa as $key => $mhs): ?>
                  <tr>
                      ...
                      <td>
                      <a href="/datamahasiswa_admin/edit/<?php echo $mhs['id']; ?>" class="button-link">Edit</a>
                        <form action="<?= base_url("/datamahasiswa_admin/delete/{$mhs['id']}") ?>" method="post" onsubmit="return confirm('Anda yakin ingin menghapus?')" style="display: inline; background: none; border: none; font-size: 14px;">
                            <input type="hidden" name="_method" value="DELETE">
                            <button type="submit" class="text-sm button-link" style="background: none; border: none; color: #007BFF; cursor: pointer;">
                                Hapus
                            </button>
                        </form>
