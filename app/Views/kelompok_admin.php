          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Dosen Pembimbing</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
...
<a href="<?= base_url('/kelompok_admin/create') ?>" class="btn btn-primary">Tambah Kelompok</a>
...
<tbody>
    ...
    <?php foreach ($kelompok as $row) : ?>
        <tr>
            ...
            <td><?= $row['ketua_kelompok'] ?></td>
            <td><?= $row['nip_dosen_pembimbing'] ?></td>
            <td><?= $row['tgl_pembentukan'] ?></td>
            <td>
                <?php
                // Buat array untuk anggota kelompok
                $anggota_kelompok = [
                    $row['npm_anggota_1'],
                    $row['npm_anggota_2'],
                    $row['npm_anggota_3'],
                ...
                // Hapus nilai null atau kosong (jika anggota belum diisi)
                $anggota_kelompok = array_filter($anggota_kelompok);

                // Tampilkan nama anggota kelompok
                echo implode(', ', $anggota_kelompok);
                ?>
            </td>
            <!-- <td>
                <a style="background: none; border: none; color: #007BFF; cursor: pointer;" href="<?= base_url('/kelompok_admin/edit/' . $row['id']) ?>"  >Edit</a>
                <form action="<?= base_url('/kelompok_admin/delete/' . $row['id']) ?>" method="post" class="d-inline">
                    <?= csrf_field() ?>
                    <input type="hidden" name="_method" value="DELETE">
                    <button type="submit" style="background: none; border: none; color: #007BFF; cursor: pointer;" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" >Hapus</button>
                </form>
            </td> -->
        </tr>
    <?php endforeach; ?>
