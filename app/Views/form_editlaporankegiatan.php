...
<style>
    ...
    background: -webkit-linear-gradient(to left, #3a6186 , #362589); /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to left, #3a6186 , #342589); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        color : #fff;    
    }
    .contact-section{
    padding-top: 40px;
...
<body>
        ...
        <section id="contact">
            ...
            <img src="<?= base_url('assets/img/logo unila.png') ?>" alt="" width="70" height="70">
                <h1 class="section-header"> <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s">EDIT LAPORAN KEGIATAN</span></h1>
